...
2. Three anonymized advisor responses labeled Response A, Response B, and Response C. Each response contains: verdict (PASS/REVISE/BLOCK), confidence, NPLF scores, top strengths, top risks, and any critical blockers.
...
5. Score your own NPLF independently (do not average the advisors' scores).
6. Determine your verdict: PASS, REVISE, or BLOCK. Remember: if there is no 2-of-3 majority on any single verdict among the advisors, that is a meaningful signal.
7. Set your confidence in your synthesis (0.0–1.0).
